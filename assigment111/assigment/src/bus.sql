...
CREATE TABLE `contactus` (
  ...
  `Complaints_reply` varchar(250) NOT NULL,
  `Questions_reply` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `contactus` (`C_ID`, `Username`, `E-mail`, `Contact_No`, `Message`, `Complaints_reply`, `Questions_reply`) VALUES
(1, 'abc', 'a1@gmail.com', 712345678, 'hall!', '', '');
